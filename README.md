...
- バージョン: **0.5.0**（検索画面・ランダム演習・handout HTML / テストプリント対応）
---
...
- 解答に非常に長い数式ブロックが含まれる一部の問題で、handout HTML（`/handout/<problem_id>`）やテスト画面において、数式ブロックが後続のテキストとオーバーラップして表示されることがあります。
	- 再現例: `http://127.0.0.1:5000/problem/03_hokudai-2019-2019_5/solution`
- 現在はスタイル調整などでの解消方法を検討中です。
